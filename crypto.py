...
st.title('Aplikacija Crypto Price BY Josip Požega')
st.markdown("""
Ova aplikacija dohvaća cijene kriptovaluta za 100 najboljih kriptovaluta s **CoinMarketCap-a** !
""")
st.markdown("""
Većina programa je na engleskom jeziku jer je tako lakše pratiti varijable, metode i slično !
""")
#---------------------------------#
# About
expander_bar = st.expander("O samoj aplikaciji")
